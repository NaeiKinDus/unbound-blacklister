...
$app = (new SingleCommandApplication())
    ...
    ->setVersion($version)
    ->addArgument(CommandProcess::ARG_PROVIDERS, InputArgument::REQUIRED, 'Path or URL to a list (plain text file) of adlist providers')
    ->addArgument(CommandProcess::ARG_BLACKLIST, InputArgument::OPTIONAL, 'Path to the unbound file used for blacklisting', '/var/unbound/conf.d/blacklist.conf')
    ->setCode(
